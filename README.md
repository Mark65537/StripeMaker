...
![Пример работы программы](./images/prog-in-work.jpg)

## Описание

Это настольное приложение для Windows (C++/CLI,

 Windows Forms), которое генерирует штрихкоды стандарта **Code 128** и позволяет быстро использовать их в документах, печати и других программах.
